...
export default function NumberInputBase({name, title, value, updateParams, min, max, step} : any) {
  return (
    <Box margin={'5px'} padding={'5px'} background={'#33334444'} borderRadius={'8px'}>
        ...
        <NumberInput value={value} precision={0} step={step} min={min} max={max} name={name} onChange={(e) => updateParams(e, name)}>
